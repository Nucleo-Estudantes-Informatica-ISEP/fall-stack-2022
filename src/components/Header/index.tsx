...
const Header: FunctionComponent<HeaderProps> = ({
    ...
    return (
        <section className="flex h-screen w-full flex-col items-center justify-around px-6">
            <img
                className="aspect-square max-h-[300px] max-w-full drop-shadow-md transition-all duration-200 hover:scale-105 hover:drop-shadow-fallstack-logo-shadow md:max-h-[400px]"
                src={logoSrc}
                alt={logoAlt}
            />
