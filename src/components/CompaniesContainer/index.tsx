...
const CompaniesContainer: FunctionComponent<CompaniesContainerProps> = ({ tier, companies }) => {
    ...
    const getTierStyling = (tier: CompaniesTier): string => {
        switch (tier) {
            case 'Diamond':
                return `border-blue-500 text-blue-500 drop-shadow-[2px_2px_2px_#3b82f6] text-4xl`;
            case 'Gold':
                return `border-yellow-400 text-yellow-400 drop-shadow-[2px_2px_2px_#facc15] text-3xl`;
            case 'Silver':
                return `border-gray-500 text-gray-500 drop-shadow-[2px_2px_2px_#6b7280] text-2xl`;
            default:
    ...
    return (
        <section className="mb-12">
            ...
            <div className="mt-12 grid grid-cols-responsiveness-180px-columns place-items-center gap-x-12 gap-y-4  xl:grid-cols-3">
